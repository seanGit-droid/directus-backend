...
import { Upload, Uid, Metadata, EVENTS, ERRORS, } from '@tus/utils';
...
export class PostHandler extends BaseHandler {
     ...
     */
    async send(req, context, headers = new Headers()) {
        ...
        if (upload_defer_length !== null && // Throw error if extension is not supported
        ...
        const writtenRes = this.write(responseData.status, responseData.headers, responseData.body);
        if (isFinal) {
