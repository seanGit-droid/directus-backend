...
import type { CachedResponseMeta, CachedStorageValue, LoadingStorageValue, StorageValue } from '../storage/types.mjs';
 ...
 */
export type KeyGenerator<R = unknown, D = unknown> = (options: CacheRequestConfig<R, D>, meta?: CachedResponseMeta) => string;
