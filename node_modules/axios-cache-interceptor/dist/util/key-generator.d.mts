...
import type { CachedResponseMeta } from '../storage/types.mjs';
 ...
 * ```
 */
export declare function buildKeyGenerator<R = unknown, D = unknown>(generator: (request: CacheRequestConfig<R, D>, meta?: CachedResponseMeta) => unknown): KeyGenerator<R, D>;
