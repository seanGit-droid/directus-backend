...
declare const CreateEmailTemplateCommand_base: {
    new (input: CreateEmailTemplateCommandInput): import("@smithy/core/client").CommandImpl<CreateEmailTemplateCommandInput, CreateEmailTemplateCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateEmailTemplateCommandInput): import("@smithy/core/client").CommandImpl<CreateEmailTemplateCommandInput, CreateEmailTemplateCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
