...
declare const DeleteSuppressedDestinationCommand_base: {
    new (input: DeleteSuppressedDestinationCommandInput): import("@smithy/core/client").CommandImpl<DeleteSuppressedDestinationCommandInput, DeleteSuppressedDestinationCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteSuppressedDestinationCommandInput): import("@smithy/core/client").CommandImpl<DeleteSuppressedDestinationCommandInput, DeleteSuppressedDestinationCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
