...
declare const DeleteContactListCommand_base: {
    new (input: DeleteContactListCommandInput): import("@smithy/core/client").CommandImpl<DeleteContactListCommandInput, DeleteContactListCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteContactListCommandInput): import("@smithy/core/client").CommandImpl<DeleteContactListCommandInput, DeleteContactListCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
