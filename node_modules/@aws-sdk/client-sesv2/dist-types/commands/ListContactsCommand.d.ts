...
declare const ListContactsCommand_base: {
    new (input: ListContactsCommandInput): import("@smithy/core/client").CommandImpl<ListContactsCommandInput, ListContactsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListContactsCommandInput): import("@smithy/core/client").CommandImpl<ListContactsCommandInput, ListContactsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
