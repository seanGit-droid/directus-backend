...
declare const CreateContactCommand_base: {
    new (input: CreateContactCommandInput): import("@smithy/core/client").CommandImpl<CreateContactCommandInput, CreateContactCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateContactCommandInput): import("@smithy/core/client").CommandImpl<CreateContactCommandInput, CreateContactCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
