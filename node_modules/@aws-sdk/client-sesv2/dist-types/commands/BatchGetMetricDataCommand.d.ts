...
declare const BatchGetMetricDataCommand_base: {
    new (input: BatchGetMetricDataCommandInput): import("@smithy/core/client").CommandImpl<BatchGetMetricDataCommandInput, BatchGetMetricDataCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchGetMetricDataCommandInput): import("@smithy/core/client").CommandImpl<BatchGetMetricDataCommandInput, BatchGetMetricDataCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
