...
declare const GetImportJobCommand_base: {
    new (input: GetImportJobCommandInput): import("@smithy/core/client").CommandImpl<GetImportJobCommandInput, GetImportJobCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetImportJobCommandInput): import("@smithy/core/client").CommandImpl<GetImportJobCommandInput, GetImportJobCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
