...
declare const ListSuppressedDestinationsCommand_base: {
    new (input: ListSuppressedDestinationsCommandInput): import("@smithy/core/client").CommandImpl<ListSuppressedDestinationsCommandInput, ListSuppressedDestinationsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListSuppressedDestinationsCommandInput]): import("@smithy/core/client").CommandImpl<ListSuppressedDestinationsCommandInput, ListSuppressedDestinationsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
