...
declare const PutConfigurationSetSuppressionOptionsCommand_base: {
    new (input: PutConfigurationSetSuppressionOptionsCommandInput): import("@smithy/core/client").CommandImpl<PutConfigurationSetSuppressionOptionsCommandInput, PutConfigurationSetSuppressionOptionsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutConfigurationSetSuppressionOptionsCommandInput): import("@smithy/core/client").CommandImpl<PutConfigurationSetSuppressionOptionsCommandInput, PutConfigurationSetSuppressionOptionsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
