...
declare const ListContactListsCommand_base: {
    new (input: ListContactListsCommandInput): import("@smithy/core/client").CommandImpl<ListContactListsCommandInput, ListContactListsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListContactListsCommandInput]): import("@smithy/core/client").CommandImpl<ListContactListsCommandInput, ListContactListsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
