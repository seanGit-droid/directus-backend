...
declare const DeleteDedicatedIpPoolCommand_base: {
    new (input: DeleteDedicatedIpPoolCommandInput): import("@smithy/core/client").CommandImpl<DeleteDedicatedIpPoolCommandInput, DeleteDedicatedIpPoolCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDedicatedIpPoolCommandInput): import("@smithy/core/client").CommandImpl<DeleteDedicatedIpPoolCommandInput, DeleteDedicatedIpPoolCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
