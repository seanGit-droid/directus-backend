...
import type { PutConfigurationSetArchivingOptionsRequest, PutConfigurationSetArchivingOptionsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const PutConfigurationSetArchivingOptionsCommand_base: {
    new (input: PutConfigurationSetArchivingOptionsCommandInput): import("@smithy/core/client").CommandImpl<PutConfigurationSetArchivingOptionsCommandInput, PutConfigurationSetArchivingOptionsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutConfigurationSetArchivingOptionsCommandInput): import("@smithy/core/client").CommandImpl<PutConfigurationSetArchivingOptionsCommandInput, PutConfigurationSetArchivingOptionsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
