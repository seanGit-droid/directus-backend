...
declare const ListImportJobsCommand_base: {
    new (input: ListImportJobsCommandInput): import("@smithy/core/client").CommandImpl<ListImportJobsCommandInput, ListImportJobsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListImportJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListImportJobsCommandInput, ListImportJobsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
