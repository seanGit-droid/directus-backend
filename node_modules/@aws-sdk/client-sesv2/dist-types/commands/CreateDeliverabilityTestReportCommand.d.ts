...
declare const CreateDeliverabilityTestReportCommand_base: {
    new (input: CreateDeliverabilityTestReportCommandInput): import("@smithy/core/client").CommandImpl<CreateDeliverabilityTestReportCommandInput, CreateDeliverabilityTestReportCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDeliverabilityTestReportCommandInput): import("@smithy/core/client").CommandImpl<CreateDeliverabilityTestReportCommandInput, CreateDeliverabilityTestReportCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
