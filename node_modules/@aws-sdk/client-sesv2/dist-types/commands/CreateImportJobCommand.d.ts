...
declare const CreateImportJobCommand_base: {
    new (input: CreateImportJobCommandInput): import("@smithy/core/client").CommandImpl<CreateImportJobCommandInput, CreateImportJobCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateImportJobCommandInput): import("@smithy/core/client").CommandImpl<CreateImportJobCommandInput, CreateImportJobCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
