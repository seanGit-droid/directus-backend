...
declare const UpdateReputationEntityPolicyCommand_base: {
    new (input: UpdateReputationEntityPolicyCommandInput): import("@smithy/core/client").CommandImpl<UpdateReputationEntityPolicyCommandInput, UpdateReputationEntityPolicyCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateReputationEntityPolicyCommandInput): import("@smithy/core/client").CommandImpl<UpdateReputationEntityPolicyCommandInput, UpdateReputationEntityPolicyCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
