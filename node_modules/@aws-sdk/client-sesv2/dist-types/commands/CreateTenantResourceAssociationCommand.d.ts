...
declare const CreateTenantResourceAssociationCommand_base: {
    new (input: CreateTenantResourceAssociationCommandInput): import("@smithy/core/client").CommandImpl<CreateTenantResourceAssociationCommandInput, CreateTenantResourceAssociationCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTenantResourceAssociationCommandInput): import("@smithy/core/client").CommandImpl<CreateTenantResourceAssociationCommandInput, CreateTenantResourceAssociationCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
