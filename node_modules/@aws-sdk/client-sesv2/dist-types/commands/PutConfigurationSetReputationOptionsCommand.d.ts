...
declare const PutConfigurationSetReputationOptionsCommand_base: {
    new (input: PutConfigurationSetReputationOptionsCommandInput): import("@smithy/core/client").CommandImpl<PutConfigurationSetReputationOptionsCommandInput, PutConfigurationSetReputationOptionsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutConfigurationSetReputationOptionsCommandInput): import("@smithy/core/client").CommandImpl<PutConfigurationSetReputationOptionsCommandInput, PutConfigurationSetReputationOptionsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
