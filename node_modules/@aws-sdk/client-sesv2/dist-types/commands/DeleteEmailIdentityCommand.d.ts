...
declare const DeleteEmailIdentityCommand_base: {
    new (input: DeleteEmailIdentityCommandInput): import("@smithy/core/client").CommandImpl<DeleteEmailIdentityCommandInput, DeleteEmailIdentityCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteEmailIdentityCommandInput): import("@smithy/core/client").CommandImpl<DeleteEmailIdentityCommandInput, DeleteEmailIdentityCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
