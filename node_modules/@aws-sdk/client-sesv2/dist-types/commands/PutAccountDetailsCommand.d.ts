...
import type { PutAccountDetailsRequest, PutAccountDetailsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const PutAccountDetailsCommand_base: {
    new (input: PutAccountDetailsCommandInput): import("@smithy/core/client").CommandImpl<PutAccountDetailsCommandInput, PutAccountDetailsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutAccountDetailsCommandInput): import("@smithy/core/client").CommandImpl<PutAccountDetailsCommandInput, PutAccountDetailsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
