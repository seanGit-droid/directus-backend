...
declare const GetMultiRegionEndpointCommand_base: {
    new (input: GetMultiRegionEndpointCommandInput): import("@smithy/core/client").CommandImpl<GetMultiRegionEndpointCommandInput, GetMultiRegionEndpointCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMultiRegionEndpointCommandInput): import("@smithy/core/client").CommandImpl<GetMultiRegionEndpointCommandInput, GetMultiRegionEndpointCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
