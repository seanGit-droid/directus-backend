...
declare const PutAccountVdmAttributesCommand_base: {
    new (input: PutAccountVdmAttributesCommandInput): import("@smithy/core/client").CommandImpl<PutAccountVdmAttributesCommandInput, PutAccountVdmAttributesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutAccountVdmAttributesCommandInput): import("@smithy/core/client").CommandImpl<PutAccountVdmAttributesCommandInput, PutAccountVdmAttributesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
