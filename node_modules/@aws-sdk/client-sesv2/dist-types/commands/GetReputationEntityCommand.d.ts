...
declare const GetReputationEntityCommand_base: {
    new (input: GetReputationEntityCommandInput): import("@smithy/core/client").CommandImpl<GetReputationEntityCommandInput, GetReputationEntityCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetReputationEntityCommandInput): import("@smithy/core/client").CommandImpl<GetReputationEntityCommandInput, GetReputationEntityCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
