...
declare const DeleteContactCommand_base: {
    new (input: DeleteContactCommandInput): import("@smithy/core/client").CommandImpl<DeleteContactCommandInput, DeleteContactCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteContactCommandInput): import("@smithy/core/client").CommandImpl<DeleteContactCommandInput, DeleteContactCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
