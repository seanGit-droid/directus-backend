...
declare const ListTenantsCommand_base: {
    new (input: ListTenantsCommandInput): import("@smithy/core/client").CommandImpl<ListTenantsCommandInput, ListTenantsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListTenantsCommandInput]): import("@smithy/core/client").CommandImpl<ListTenantsCommandInput, ListTenantsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
