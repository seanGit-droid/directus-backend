...
declare const CreateDedicatedIpPoolCommand_base: {
    new (input: CreateDedicatedIpPoolCommandInput): import("@smithy/core/client").CommandImpl<CreateDedicatedIpPoolCommandInput, CreateDedicatedIpPoolCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDedicatedIpPoolCommandInput): import("@smithy/core/client").CommandImpl<CreateDedicatedIpPoolCommandInput, CreateDedicatedIpPoolCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
