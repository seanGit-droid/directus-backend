...
import type { GetTenantRequest, GetTenantResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetTenantCommand_base: {
    new (input: GetTenantCommandInput): import("@smithy/core/client").CommandImpl<GetTenantCommandInput, GetTenantCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTenantCommandInput): import("@smithy/core/client").CommandImpl<GetTenantCommandInput, GetTenantCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
