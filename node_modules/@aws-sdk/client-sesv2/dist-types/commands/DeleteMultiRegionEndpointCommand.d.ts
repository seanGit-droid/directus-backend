...
declare const DeleteMultiRegionEndpointCommand_base: {
    new (input: DeleteMultiRegionEndpointCommandInput): import("@smithy/core/client").CommandImpl<DeleteMultiRegionEndpointCommandInput, DeleteMultiRegionEndpointCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteMultiRegionEndpointCommandInput): import("@smithy/core/client").CommandImpl<DeleteMultiRegionEndpointCommandInput, DeleteMultiRegionEndpointCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
