...
declare const ListTenantResourcesCommand_base: {
    new (input: ListTenantResourcesCommandInput): import("@smithy/core/client").CommandImpl<ListTenantResourcesCommandInput, ListTenantResourcesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListTenantResourcesCommandInput): import("@smithy/core/client").CommandImpl<ListTenantResourcesCommandInput, ListTenantResourcesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
