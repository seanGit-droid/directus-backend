...
declare const PutAccountSendingAttributesCommand_base: {
    new (input: PutAccountSendingAttributesCommandInput): import("@smithy/core/client").CommandImpl<PutAccountSendingAttributesCommandInput, PutAccountSendingAttributesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [PutAccountSendingAttributesCommandInput]): import("@smithy/core/client").CommandImpl<PutAccountSendingAttributesCommandInput, PutAccountSendingAttributesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
