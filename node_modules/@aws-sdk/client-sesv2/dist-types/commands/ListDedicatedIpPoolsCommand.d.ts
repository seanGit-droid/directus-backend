...
declare const ListDedicatedIpPoolsCommand_base: {
    new (input: ListDedicatedIpPoolsCommandInput): import("@smithy/core/client").CommandImpl<ListDedicatedIpPoolsCommandInput, ListDedicatedIpPoolsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDedicatedIpPoolsCommandInput]): import("@smithy/core/client").CommandImpl<ListDedicatedIpPoolsCommandInput, ListDedicatedIpPoolsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
