...
declare const GetSuppressedDestinationCommand_base: {
    new (input: GetSuppressedDestinationCommandInput): import("@smithy/core/client").CommandImpl<GetSuppressedDestinationCommandInput, GetSuppressedDestinationCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSuppressedDestinationCommandInput): import("@smithy/core/client").CommandImpl<GetSuppressedDestinationCommandInput, GetSuppressedDestinationCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
