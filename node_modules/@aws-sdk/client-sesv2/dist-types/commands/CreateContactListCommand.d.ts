...
declare const CreateContactListCommand_base: {
    new (input: CreateContactListCommandInput): import("@smithy/core/client").CommandImpl<CreateContactListCommandInput, CreateContactListCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateContactListCommandInput): import("@smithy/core/client").CommandImpl<CreateContactListCommandInput, CreateContactListCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
