...
declare const CreateTenantCommand_base: {
    new (input: CreateTenantCommandInput): import("@smithy/core/client").CommandImpl<CreateTenantCommandInput, CreateTenantCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTenantCommandInput): import("@smithy/core/client").CommandImpl<CreateTenantCommandInput, CreateTenantCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
