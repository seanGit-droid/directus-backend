...
declare const GetMessageInsightsCommand_base: {
    new (input: GetMessageInsightsCommandInput): import("@smithy/core/client").CommandImpl<GetMessageInsightsCommandInput, GetMessageInsightsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMessageInsightsCommandInput): import("@smithy/core/client").CommandImpl<GetMessageInsightsCommandInput, GetMessageInsightsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
