...
import type { CreateEmailIdentityPolicyRequest, CreateEmailIdentityPolicyResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateEmailIdentityPolicyCommand_base: {
    new (input: CreateEmailIdentityPolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateEmailIdentityPolicyCommandInput, CreateEmailIdentityPolicyCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateEmailIdentityPolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateEmailIdentityPolicyCommandInput, CreateEmailIdentityPolicyCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
