...
declare const ListResourceTenantsCommand_base: {
    new (input: ListResourceTenantsCommandInput): import("@smithy/core/client").CommandImpl<ListResourceTenantsCommandInput, ListResourceTenantsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListResourceTenantsCommandInput): import("@smithy/core/client").CommandImpl<ListResourceTenantsCommandInput, ListResourceTenantsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
