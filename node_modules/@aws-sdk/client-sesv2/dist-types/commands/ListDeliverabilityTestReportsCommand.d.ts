...
declare const ListDeliverabilityTestReportsCommand_base: {
    new (input: ListDeliverabilityTestReportsCommandInput): import("@smithy/core/client").CommandImpl<ListDeliverabilityTestReportsCommandInput, ListDeliverabilityTestReportsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDeliverabilityTestReportsCommandInput]): import("@smithy/core/client").CommandImpl<ListDeliverabilityTestReportsCommandInput, ListDeliverabilityTestReportsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
