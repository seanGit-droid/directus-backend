...
declare const PutAccountDedicatedIpWarmupAttributesCommand_base: {
    new (input: PutAccountDedicatedIpWarmupAttributesCommandInput): import("@smithy/core/client").CommandImpl<PutAccountDedicatedIpWarmupAttributesCommandInput, PutAccountDedicatedIpWarmupAttributesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [PutAccountDedicatedIpWarmupAttributesCommandInput]): import("@smithy/core/client").CommandImpl<PutAccountDedicatedIpWarmupAttributesCommandInput, PutAccountDedicatedIpWarmupAttributesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
