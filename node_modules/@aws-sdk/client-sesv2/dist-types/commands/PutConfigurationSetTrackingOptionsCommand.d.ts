...
declare const PutConfigurationSetTrackingOptionsCommand_base: {
    new (input: PutConfigurationSetTrackingOptionsCommandInput): import("@smithy/core/client").CommandImpl<PutConfigurationSetTrackingOptionsCommandInput, PutConfigurationSetTrackingOptionsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutConfigurationSetTrackingOptionsCommandInput): import("@smithy/core/client").CommandImpl<PutConfigurationSetTrackingOptionsCommandInput, PutConfigurationSetTrackingOptionsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
