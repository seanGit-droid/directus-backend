...
declare const DeleteEmailTemplateCommand_base: {
    new (input: DeleteEmailTemplateCommandInput): import("@smithy/core/client").CommandImpl<DeleteEmailTemplateCommandInput, DeleteEmailTemplateCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteEmailTemplateCommandInput): import("@smithy/core/client").CommandImpl<DeleteEmailTemplateCommandInput, DeleteEmailTemplateCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
