...
declare const ListMultiRegionEndpointsCommand_base: {
    new (input: ListMultiRegionEndpointsCommandInput): import("@smithy/core/client").CommandImpl<ListMultiRegionEndpointsCommandInput, ListMultiRegionEndpointsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListMultiRegionEndpointsCommandInput]): import("@smithy/core/client").CommandImpl<ListMultiRegionEndpointsCommandInput, ListMultiRegionEndpointsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
