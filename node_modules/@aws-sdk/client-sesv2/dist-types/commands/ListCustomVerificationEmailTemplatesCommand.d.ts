...
declare const ListCustomVerificationEmailTemplatesCommand_base: {
    new (input: ListCustomVerificationEmailTemplatesCommandInput): import("@smithy/core/client").CommandImpl<ListCustomVerificationEmailTemplatesCommandInput, ListCustomVerificationEmailTemplatesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCustomVerificationEmailTemplatesCommandInput]): import("@smithy/core/client").CommandImpl<ListCustomVerificationEmailTemplatesCommandInput, ListCustomVerificationEmailTemplatesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
