...
declare const ListReputationEntitiesCommand_base: {
    new (input: ListReputationEntitiesCommandInput): import("@smithy/core/client").CommandImpl<ListReputationEntitiesCommandInput, ListReputationEntitiesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListReputationEntitiesCommandInput]): import("@smithy/core/client").CommandImpl<ListReputationEntitiesCommandInput, ListReputationEntitiesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
