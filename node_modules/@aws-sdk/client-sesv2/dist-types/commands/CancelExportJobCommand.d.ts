...
declare const CancelExportJobCommand_base: {
    new (input: CancelExportJobCommandInput): import("@smithy/core/client").CommandImpl<CancelExportJobCommandInput, CancelExportJobCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelExportJobCommandInput): import("@smithy/core/client").CommandImpl<CancelExportJobCommandInput, CancelExportJobCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
