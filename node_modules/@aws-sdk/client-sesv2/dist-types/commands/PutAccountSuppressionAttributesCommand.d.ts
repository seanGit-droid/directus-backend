...
declare const PutAccountSuppressionAttributesCommand_base: {
    new (input: PutAccountSuppressionAttributesCommandInput): import("@smithy/core/client").CommandImpl<PutAccountSuppressionAttributesCommandInput, PutAccountSuppressionAttributesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [PutAccountSuppressionAttributesCommandInput]): import("@smithy/core/client").CommandImpl<PutAccountSuppressionAttributesCommandInput, PutAccountSuppressionAttributesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
