...
declare const ListExportJobsCommand_base: {
    new (input: ListExportJobsCommandInput): import("@smithy/core/client").CommandImpl<ListExportJobsCommandInput, ListExportJobsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListExportJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListExportJobsCommandInput, ListExportJobsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
