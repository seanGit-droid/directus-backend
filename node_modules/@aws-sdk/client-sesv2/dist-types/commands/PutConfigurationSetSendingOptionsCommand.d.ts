...
declare const PutConfigurationSetSendingOptionsCommand_base: {
    new (input: PutConfigurationSetSendingOptionsCommandInput): import("@smithy/core/client").CommandImpl<PutConfigurationSetSendingOptionsCommandInput, PutConfigurationSetSendingOptionsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutConfigurationSetSendingOptionsCommandInput): import("@smithy/core/client").CommandImpl<PutConfigurationSetSendingOptionsCommandInput, PutConfigurationSetSendingOptionsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
