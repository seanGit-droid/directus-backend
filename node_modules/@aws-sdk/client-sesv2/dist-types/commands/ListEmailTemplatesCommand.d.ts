...
declare const ListEmailTemplatesCommand_base: {
    new (input: ListEmailTemplatesCommandInput): import("@smithy/core/client").CommandImpl<ListEmailTemplatesCommandInput, ListEmailTemplatesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListEmailTemplatesCommandInput]): import("@smithy/core/client").CommandImpl<ListEmailTemplatesCommandInput, ListEmailTemplatesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
