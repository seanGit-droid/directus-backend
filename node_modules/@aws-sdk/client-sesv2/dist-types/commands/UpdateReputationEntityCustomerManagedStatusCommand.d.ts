...
import type { UpdateReputationEntityCustomerManagedStatusRequest, UpdateReputationEntityCustomerManagedStatusResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const UpdateReputationEntityCustomerManagedStatusCommand_base: {
    new (input: UpdateReputationEntityCustomerManagedStatusCommandInput): import("@smithy/core/client").CommandImpl<UpdateReputationEntityCustomerManagedStatusCommandInput, UpdateReputationEntityCustomerManagedStatusCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateReputationEntityCustomerManagedStatusCommandInput): import("@smithy/core/client").CommandImpl<UpdateReputationEntityCustomerManagedStatusCommandInput, UpdateReputationEntityCustomerManagedStatusCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
