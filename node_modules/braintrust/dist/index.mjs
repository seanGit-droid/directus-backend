...
async function registerSandbox(options) {
  ...
  const evaluatorDefinitions = z.record(z.unknown()).parse(await listResponse.json());
  const functions = [];
...
var promptContentsSchema = z2.union([
  z2.object({
    prompt: z2.string()
  }),
  z2.object({
    messages: z2.array(ChatCompletionMessageParam)
  })
]);
var promptDefinitionSchema = promptContentsSchema.and(
  z2.object({
    ...
    templateFormat: z2.enum(["mustache", "nunjucks", "none"]).optional(),
    environments: z2.array(z2.string()).optional()
  })
);
var promptDefinitionWithToolsSchema = promptDefinitionSchema.and(
  z2.object({
    tools: z2.array(ToolFunctionDefinition).optional()
  })
);
...
// src/eval-parameters.ts
var evalParametersSchema = z3.record(
  z3.string(),
  z3.union([
    z3.object({
  ...
  return Object.fromEntries(
    Object.entries(parameters).map(([name, value]) => {
      ...
      if (Reflect.get(propertySchema, "x-bt-type") === "prompt") {
        return [
          name,
          Prompt.fromPromptData(name, PromptData.parse(value))
        ];
      }
      return [name, value];
    })
...
var staticParametersSchema = z5.record(
  z5.string(),
  z5.union([
    z5.object({
    ...
    z5.object({
      type: z5.literal("model"),
      default: z5.string().optional(),
      description: z5.string().optional()
    }),
    z5.object({
      type: z5.literal("data"),
      schema: z5.record(z5.unknown()),
      default: z5.unknown().optional(),
      description: z5.string().optional()
    })
  ])
);
var parametersSchema = z5.object({
  type: z5.literal("object"),
  properties: z5.record(z5.string(), z5.record(z5.unknown())),
  required: z5.array(z5.string()).optional(),
  additionalProperties: z5.boolean().optional()
});
var parametersSourceSchema = z5.object({
  parametersId: z5.string().optional(),
  slug: z5.string(),
  name: z5.string(),
  projectId: z5.string().optional(),
  version: z5.string().optional()
});
var parametersContainerSchema = z5.object({
  type: z5.literal("braintrust.parameters"),
  schema: parametersSchema,
  source: parametersSourceSchema
});
var staticParametersContainerSchema = z5.object({
  type: z5.literal("braintrust.staticParameters"),
  schema: staticParametersSchema,
  source: z5.null().nullish()
});
var serializedParametersContainerSchema = z5.union([
...
var evaluatorDefinitionSchema = z5.object({
  parameters: serializedParametersContainerSchema.nullish(),
  scores: z5.array(z5.object({ name: z5.string() })).optional(),
  classifiers: z5.array(z5.object({ name: z5.string() })).optional()
});
var evaluatorDefinitionsSchema = z5.record(
  z5.string(),
