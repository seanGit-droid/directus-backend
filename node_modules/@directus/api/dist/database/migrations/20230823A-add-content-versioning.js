...
//#region src/database/migrations/20230823A-add-content-versioning.ts
async function up(knex) {
	...
	await knex.schema.createTable("directus_versions", (table) => {
		...
		table.string("name");
		table.string("collection", helpers.schema.getTableNameMaxLength()).notNullable().references("collection").inTable("directus_collections").onDelete("CASCADE");
