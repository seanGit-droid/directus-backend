...
//#region src/database/migrations/20210510A-restructure-relations.ts
async function up(knex) {
	...
	await helper.schema.changeToType("directus_relations", "sort_field", "string", { length: helper.schema.getColumnNameMaxLength() });
...
async function down(knex) {
	const helper = getHelpers(knex);
	await helper.schema.changeToType("directus_relations", "sort_field", "string", { length: 255 });
	await knex.schema.alterTable("directus_relations", (table) => {
