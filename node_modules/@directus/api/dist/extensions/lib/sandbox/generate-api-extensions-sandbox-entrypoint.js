...
import { registerActionGenerator } from "./register/action.js";
import { registerFilterGenerator } from "./register/filter.js";
import { registerOperationGenerator } from "./register/operation.js";
import { registerRouteGenerator } from "./register/route.js";
import "./register/index.js";
import { numberGenerator } from "@directus/utils";

//#region src/extensions/lib/sandbox/generate-api-extensions-sandbox-entrypoint.ts
/**
...
*/
function generateApiExtensionsSandboxEntrypoint(type, name, endpointRouter) {
	...
	if (type === "hook") {
		...
		const code = `
			...
			const registerRoute = ${generateHostFunctionReference(index, [
			"path",
			"method",
			"handler"
		], { async: false })}
...
//#endregion
export { generateApiExtensionsSandboxEntrypoint };