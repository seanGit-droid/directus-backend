...
//#region src/extensions/lib/sandbox/sdk/instantiate.ts
/**
...
*/
async function instantiateSandboxSdk(isolate, requestedScopes) {
	...
	await apiContext.evalClosure(handlerCode, sdk.map(({ name, generator, async }) => async ? wrap(name, generator(requestedScopes)) : generator(requestedScopes)), {
		filename: "<extensions-sdk>",
